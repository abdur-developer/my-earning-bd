...
<html lang="en">
    ...
    <head>
        ...
        <!-- FAVICON -->
        <link rel="shortcut icon" href="assets/img/favicon_x.png">
        ...
        <div class="popup">
            ...
            <div class="card">
                    ...
                    <form action="assets/php/subscribe.php" method="post" class="subscribe-form">
                        ...
                        <input type="email" name="email" placeholder="* Enter your Email" onfocus="this.placeholder = ''" onblur="this.placeholder = '* Enter your Email'" class="email form-control">
